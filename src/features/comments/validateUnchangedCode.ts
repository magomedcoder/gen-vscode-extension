...
import { stripComments } from './styles';

export type { CommentStyleConfig, CommentStyleId } from './styles';
export { stripComments, resolveCommentStyleId, getCommentStyleConfig, COMMENT_STYLES } from './styles';
